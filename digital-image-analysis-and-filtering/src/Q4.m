...
images_a = {fuzzy_cat,averaging_img_5, fuzzy_cat-averaging_img_5};
labels_a = {"Original Image","Averaging Filter","Difference Image"};
showImages(images_a,labels_a,"Q4_Resulting_Images/a","Averaging Box Filtering 5x5",1,3)
...
for i=1:5
    ...
    differences{length(differences)+1} = g-fuzzy_cat; 
...
showImages(differences,labels_b(2:6),"Q4_Resulting_Images/b","Unsharp Masking Differences",2,3)
