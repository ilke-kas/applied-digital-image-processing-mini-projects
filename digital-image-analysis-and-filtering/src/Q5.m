...
average_fft = fft2(averaging_kernel_3,5,5)
laplacian_fft = fft2(laplacian_filter,5,5)
one_pass_filter_fft = average_fft .* laplacian_fft
one_pass_filter_ifft = real(ifft(one_pass_filter_fft,5,5))
one_pass_filter_ifft = one_pass_filter_ifft(:,:,1,1,1)
